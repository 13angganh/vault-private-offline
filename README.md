...
- ✨ **First-time warning** — peringatan lebih kuat jika belum pernah backup sama sekali
- ✨ **Interval backup fleksibel** — pilih 12 jam / 24 jam / 3 hari / 7 hari di Pengaturan
- ✨ **Status backup di Pengaturan** — tampilkan kapan terakhir backup dan apakah data sudah berubah
- ✨ **Deteksi perubahan data** — pengingat hanya muncul jika ada entry baru/diedit sejak backup terakhir
